...
@app.cell
def _(df, fast_window, mordor, mo, slow_window, istari):
    mo.md('## Backtest execution')

    strategy = istari.Gandalf(
...
@app.cell
def _(exec_result, firm_config, mordor, strategy, symbol, timeframe):
