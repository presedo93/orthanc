...
Designed for HIGH_VOLATILITY regimes, especially during transitions
...
from ..features import atr, bollinger_width, range_compression
...
register_strategy('volatility_breakout', VolatilityBreakout)
