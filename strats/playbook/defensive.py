...
Designed for unstable regimes and transitions. This strategy
intentionally generates no entry signals, reducing overall exposure.

When weighted in a multi-strategy system, it dilutes the overall
signal strength, effectively reducing position sizing and trade
frequency.
"""
