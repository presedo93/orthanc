"""SMA Crossover strategy — Gandalf the Grey.

Technical name: SMA Crossover (sma_cross.py).
...
Gandalf walks slowly but sees far — like the moving average crossover.
"""
