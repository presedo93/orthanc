"""Trend Following strategy — Aragorn, son of Arathorn.

Technical name: Trend Follow (trend_follow.py).

Enters on breakouts with EMA alignment confirmation. Uses ATR-based
trailing stops and structure breaks for exits. Designed for AGE_OF_KINGS
and FALL_OF_NUMENOR regimes. Aragorn leads from the front — always
