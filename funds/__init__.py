...
constraints. Takes execution results from the strategy layer and applies
firm rules (daily loss, total loss, trailing drawdown, profit targets)
day-by-day to determine if the account passes, fails, or survives.
"""
