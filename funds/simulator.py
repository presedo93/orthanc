...
from strats import ExecutionResult

from .config import FirmConfig, FirmRuleSet
from .models import (
    AccountState,
    DailyLedgerRow,
    FailureReason,
...
def simulate_account(
    ...
    for date in dates:
        ...
        # Check rules
        breach = check_all_rules(state, rules)
        ...
        # Check profit target
        target_hit = check_profit_target(state, rules)
        min_days_met = check_min_trading_days(state, rules)
